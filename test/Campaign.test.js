...
beforeEach(async ()=>{
  ...
  const addresses = await factory.methods.getDeployCampaign().call();
  campaignAddress = addresses[0];

  campaign = await new web3.eth.Contract(
      JSON.parse(compileCampaign.interface),campaignAddress);
...
describe('Campaign',() =>{
  ...
  it('allow to manager make a payment request', async() =>{
